      ...
      <main className={styles.main}>
        ...
        <div className={styles.card}>
            ...
            <div className={styles.card}>
              ...
              <h3>The Personally Identifiable Information (PII) check ensures individual's privacy by removing sensitive data. Note that it is your responsibility to remvoe PII--this is only a surface-level check.</h3>
